...
//           <h1 className="text-5xl md:text-6xl font-bold mt-4 text-black">
//             Search Artists & Artworks
//           </h1>

//           <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
//             Find original creators, premium artworks, custom commissions and
//             unique styles crafted by talented artists worldwide.
//           </p>
...
//               className="w-full px-7 py-5 rounded-full bg-white border border-white/40 backdrop-blur-xl shadow-xl outline-none text-lg"
//             />
//           </div>
//         </div>
//       </section>
...
//           <div className="flex gap-5 overflow-x-auto pb-3 scrollbar-none overflow-x-auto mb-4 py-3 scrollbar-none [ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
//             {filteredArtists.map((artist) => (
//               <div
//                 key={artist.id}
//                 className="min-w-[220px] bg-white rounded-3xl p-4 shadow-md hover:scale-105 transition"
//               >
//                 <Image
...
//                 <h3 className="font-semibold text-lg mt-4">{artist.name}</h3>
//                 <p className="text-sm text-gray-500">{artist.style}</p>
//               </div>
//             ))}
//           </div>
//         </div>
...
//               <div
//                 key={art.id}
//                 className="bg-white rounded-3xl overflow-hidden shadow-md hover:-translate-y-1 hover:shadow-xl transition"
//               >
//                 <Image
//                   src={art.image_url}
//                   alt={art.title}
...
//                   <p className="text-sm text-gray-500 mt-1">{art.artist}</p>
